...
public static class dict
{
    ...
    {
        string _str = str;
        _str = _str.Replace("三栄町", "(三栄町|四谷三栄町)")
                    .Replace("四谷三栄町", "(三栄町|四谷三栄町)")
                    .Replace("鬮野川", "(鬮野川|くじ野川|くじの川)")
                    .Replace("くじ野川", "(鬮野川|くじ野川|くじの川)")
                    .Replace("くじの川", "(鬮野川|くじ野川|くじの川)")
                    .Replace("柿碕町", "(柿碕町|柿さき町)")
                    .Replace("柿さき町", "(柿碕町|柿さき町)")
                    .Replace("通り", "(通り|とおり)")
                    .Replace("とおり", "(通り|とおり)")
                    .Replace("埠頭", "(埠頭|ふ頭)")
                    .Replace("ふ頭", "(埠頭|ふ頭)")
                    ...
                    .Replace("薭", "(薭|稗|ひえ|ヒエ)")
                    .Replace("稗", "(薭|稗|ひえ|ヒエ)")
                    .Replace("ひえ", "(薭|稗|ひえ|ヒエ)")
                    .Replace("ヒエ", "(薭|稗|ひえ|ヒエ)")
                    .Replace("[之]", "[之ノの]")
                    .Replace("[ノ]", "[之ノの]")
                    .Replace("[の]", "[之ノの]")
                    .Replace("[ヶ]", "[ヶケが]")
